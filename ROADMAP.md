...
Status: `v1.9.0` released and fully closed on 2026-07-15. `v2.0.0 — Apple-Inspired Inspector Workspace` has completed and frozen Slices 20A–20E; Slice 20F is next but not started.
...
| Apple-Inspired Inspector Workspace | In progress | `v2.0.0` | Slices 20A–20E are complete and frozen; Slice 20F is next but not started |
...
Status: In progress. Slices 20A–20E are complete and frozen. Slice 20F is next but not started.
...
6. 20F — next, not started: comparison and Raw Local View.
...
`b86a44cf2cbb0a3400a307ede92e7623c7417b48`. Slices 20B–20E are complete and
frozen after production shell, import/navigation, report-content, search/action,
accessibility, browser, performance, PWA, and regression validation. Slice 20C is recorded by
...
Slice 20F is next but not started.
