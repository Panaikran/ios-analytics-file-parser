...
Status: `v1.9.0` released and fully closed on 2026-07-15. `v2.0.0 — Apple-Inspired Inspector Workspace` has completed and frozen Slices 20A–20F; Slice 20G is next but not started.
...
| Apple-Inspired Inspector Workspace | In progress | `v2.0.0` | Slices 20A–20F are complete and frozen; Slice 20G is next but not started |
...
Status: In progress. Slices 20A–20F are complete and frozen. Slice 20G is next but not started.
...
7. 20G — next, not started: responsive and accessibility hardening.
...
`b86a44cf2cbb0a3400a307ede92e7623c7417b48`. Slices 20B–20F are complete and
...
Slice 20G is next but not started.
