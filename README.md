...
| v2.1.0 | Released: privacy-safe direct battery report presentation |
...
Phase 21 is complete and frozen, and v2.1.0 is tagged and published. Supported
CoreAnalytics reports may
...
| Battery and Charging report section | Released in `v2.1.0`: optional direct battery metrics only; charging extraction remains deferred |
